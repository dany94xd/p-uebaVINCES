...
$CiudadCollectorObj = new CiudadCollector(); 
 ...
 echo "</div>";
 echo "</nav>";
 echo "<form method= 'POST' class='form-horizontal' action= 'nuevaMuseo.php' id='museo' title='Museo'>";
...
echo "<label for='inputName' class='control-label col-xs-2'>Ciudad:</label>";
         echo "<div class='col-xs-10'>";
             echo "<select name='id_ciudad_fk'  id= 'id_ciudad_fk' class='form-control' required>";
...
<div class="text-fieldsl">
  <a href='readMuseo.php'>Regresar</a>                                          
</div>
</aside>
<?php
}   
